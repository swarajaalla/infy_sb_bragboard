  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <form onSubmit={handleLogin} className="bg-white shadow-md rounded p-6 w-80">
        ...
        <button type="submit" className="bg-blue-600 text-white w-full py-2 rounded mt-2 hover:bg-blue-700 transition">
          Login
        </button>

        <div className="text-center mt-3 text-sm">
          New user? <Link to="/register" className="text-blue-600 font-medium">Create account</Link>
        </div>
      </form>
    </div>
  );
